...
sh /usr/local/src/aria2-static-builds/build-scripts/gnu-linux-config/aria2-i386-gnu-linux-cross-build-libs
cd /tmp;
...
cd aria2-1.34.0;
sh /usr/local/src/aria2-static-builds/build-scripts/gnu-linux-config/aria2-i386-gnu-linux-cross-config
